...
Les points d'intérêt sont affichés directement sur la carte sous forme de marqueurs.

Chaque type de point possède une catégorie permettant de l'identifier facilement.

Les principales catégories prévues sont :
...
Points d'intérêt créés par les utilisateurs
...
- Ajouter des points d'intérêt sur la carte
- Commenter les points d'intérêt
...
Wamp ou un équivalent permettant de lancer PHP et MySQL.
